...
export function ServicesSection({ language = "de" }: { language?: "de" | "en" }) {
  ...
  return (
    <section id="services" aria-labelledby="services-heading" className="w-full py-12 lg:px-4 xl:px-8">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:-mx-16 lg:grid-cols-12 lg:gap-5 xl:-mx-28 2xl:-mx-40">
        {items.map((service, index) => (
          <BlurFade key={service.title} delay={0.28 + index * 0.05} className={index < 3 ? "lg:col-span-4" : index === 3 ? "lg:col-start-3 lg:col-span-3" : "lg:col-start-7 lg:col-span-3"}>
