...
function EmailFunnelPreview() {
  return (
    <div className="relative flex min-h-[250px] flex-1 items-center justify-start overflow-hidden border-b bg-background p-3 sm:p-5">
      <div className="flex w-full max-w-[560px] items-center justify-start overflow-hidden rounded-xl border bg-background/70 px-2 py-3 sm:px-4">
